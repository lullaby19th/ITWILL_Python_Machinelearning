...
X = lol[[ '출전횟수', '승률', 'K', 'D', 'A', 'KDA', '킬관여울', '데스관여율',
...
X = preprocessing.StandardScaler().fit(X).transform(X) # train 데이터 정규화
...
print(y.values[0:20]) # 실제 데이터 10개


# F1-report 확인코드
from sklearn import metrics

f1_report = metrics.classification_report(y, y_pred)
print(f1_report,'\n')
